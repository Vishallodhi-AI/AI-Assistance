...
const handleCommands = (command) => {
    ...
    } else if (command.includes("hu r u ") || command.includes("developed") || command.includes("hu r u")) {
        speakFunc("I am a Virtual Assistant, Developed By Vishal Lodhi.!");
    ...
    } else if (command.includes("ramkumar_techx") || command.includes("instagram")) {
        speakFunc("Opening...Ramkumar_Techx Instagram");
        window.open("https://www.instagram.com/ramkumar_techx/");
    } else {
